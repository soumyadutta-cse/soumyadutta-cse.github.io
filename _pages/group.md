...
<div class="row">
  ...
  <div class="column">
  <div class="card" style="border: 1px solid lightgray; padding: 10px; border-radius: 5px; text-align: center; display: inline-block;">
    <img src="/images/anubhav.jpg" alt="anubhav" style="width:60%; border-radius: 50%;">
    <div class="container" style="margin-top: 8px; line-height: 1.4;">
      <b>Anubhav Dixit</b><br>
      Ph.D. Candidate<br>
<!--       [07/2022–present] -->
    </div>
  </div>
  ...
  <div class="column">
  <div class="card" style="border: 1px solid lightgray; padding: 10px; border-radius: 5px; text-align: center; display: inline-block;">
    <img src="/images/shanu.png" alt="shanu" style="width:60%; border-radius: 50%;">
    <div class="container" style="margin-top: 8px; line-height: 1.4;">
      <b>Shanu Saklani</b><br>
      Ph.D. Candidate<br>
<!--       [07/2023–present] -->
    </div>
  </div>
...
<div class="row">
  ...
  <div class="column">
  <div class="card" style="border: 1px solid lightgray; padding: 10px; border-radius: 5px; text-align: center; display: inline-block;">
    <img src="/images/ananya.jpg" alt="ananya" style="width:60%; border-radius: 50%;">
    <div class="container" style="margin-top: 8px; line-height: 1.4;">
      <b>Ananya Chaturvedi</b><br>
      Ph.D. Candidate<br>
<!--       [07/2024–present] -->
    </div>
  </div>
...
<!--       [01/2025–present] -->
  ...
  <div class="column">
  <div class="card" style="border: 1px solid lightgray; padding: 10px; border-radius: 5px; text-align: center; display: inline-block;">
    <img src="/images/robin.jpg" alt="robin" style="width:60%; border-radius: 50%;">
    <div class="container" style="margin-top: 8px; line-height: 1.4;">
      <b>Robin Shah</b><br>
      Ph.D. Student<br>
<!--       [07/2025–present] -->
...
Thesis: Efficient Compression of Implicit Neural Networks for 3D Scalar Field Learning via Pruning with User-Guided Quality Control<br><br>

10. <b>Shaurya Agarwal | M.Tech. CSE | Batch'23</b> <br>
Thesis: A Multi-Modal Smart Search Framework for Person Identification via Facial Recognition and Textual Retrieval<br><br>

9. <b>Shubham Srivastava | M.Tech. CSE | Batch'23</b> <br>
Thesis: Understanding Adversarial Attacks on Deep Neural Networks via Interactive Visual Analytics<br><br>

8. <b>Prashik Ganer | M.Tech. CSE | Batch'23 (Co-supervisor: Prof. Purushottam Kar)</b> <br>
Thesis: DAVi II - Design and Development of a Data Analytics and Visualization Platform<br><br>

7. <b>Manish Agrawal | M.Tech. CSE | Batch'23 (Co-supervisor: Prof. Purushottam Kar)</b> <br>
Thesis: DAVi I - Design and Development of a Data Analytics and Visualization Platform<br><br>

6. <b>Vishal Kumar | M.Tech. CyS | Batch'23</b> <br>
Thesis: Combating DeepFakes with GAN-Based Watermarking and Adversarial Robustness Evaluation<br><br>

5. <b>Atul Kumar | M.Tech. CSE | Batch'22</b> <br>
Thesis: Uncertainty-Aware Implicit Neural Networks for Visual Analytics of Complex Vector Fields<br><br> 

4. <b>Abhay Kumar Dwivedi | M.Tech. CSE | Batch'22</b> <br>
Thesis: Implicit Neural Networks for Visual Analytics of Large Multivariate Data<br><br>

3. <b>Komal Yadav | M.Tech. CSE | Batch'22</b> <br>
Thesis: Impact of Adaptive Sampling for Building Comprerssive Neural Representations of Large Scientific Data<br><br>

2. <b>Vivek Kumar Gautam | M.Tech. CSE | Batch'22</b> <br>
Thesis: Efficient View Synthesis of Scientific Data via Deep Image Regression<br><br> 

1. <b>Drashtant Singh Rathod | M.Tech. CSE | Batch'22</b> <br>
Project: Understanding Adversarial Attacks using Techniques of Explainability and Interactive Visual Analytics<br><br> 
...
17. Raghav Manglik [CSE] <br>
    Project Title: Bidirectional Generative Modelling for Transfer Function-Aware Explorable View Synthesis of 3D Data<br>
16. Shrilakshmi S K [CSE] <br>
    Project Title: Autoencoder-Based Local Latent Modeling for Ensemble Data Compression and Feature Analysis<br>
15. Palak Mishra [SDS] <br>
    Project Title: Efficient 3D Data Summarization and Recovery via Void-and-Cluster Sampling and Neural Network-based Reconstruction<br>
14. Manasvi Jain [CSE] <br>
    Project Title: Local Latent Representations for Compressed and Interpretable 3D Scalar Data Analysis<br>
13. Depanshu Sahu [CSE] <br>
    Project Title: In-Situ Copula Modeling for Large-Scale Simulations<br>
...
9. Aditya Bangar [CSE] <br>
    Project Title: Uncertainty Aware Affective Behavior Analysis: Baseline Setup<br>
8. Ahmad Amaan [ME] <br>
    Project Title: Evaluating Generative Models for Volume Visualization<br>
7. Yerusu Dharini Reddy [EE] <br>
    Project Title: Evaluating CoordNet for Diverse Visualization Generation Tasks<br>
6. Navya [EE] <br>
    Project Title: Evaluating CoordNet for Diverse Visualization Generation Tasks<br>
5. Rashmi G R [CSE] <br>
    Project Title: Frailty Data Analysis and Visualization<br>
4. Ayush Kumar [EE] <br>
    Project Title: Visualizing Impact of Uncertainty and Adversarial Attack on Deep Classifier Models<br>
3. Yashwant Mahajan [EE] <br>
    Project Title: Visualizing Impact of Uncertainty and Adversarial Attack on Deep Classifier Models<br>
2. Faheem Nizar [EE] <br>
    Project Title: Exploring Uncertainty in Deep Learning Models using Interactive Visual Analytics<br>
1. Ahmad Amaan [ME] <br>
    Project Title: Estimation and Visual Analytics of Uncertainty in Deep Image Synthesizing Models<br>

<h2 style="text-align:left">SURGE Students</h2>

2. Narendra Singh (CSE) [Summer 2023]<br>
    Project Title: Visualizing Convolutional Neural Networks for Explainability and Interpretability<br>
